...
object HigherOrder {
  def main(args: Array[String]): Unit = {
    println("Функция nTimes, сложение: " + testNTimes(plus, 6,9,3))
    println("Функция nTimes, умножение : " + testNTimes(multiply,4,2,8))
    println("Анонимная функция : " + testAnonymousNTimes(9,3,6))
  }
